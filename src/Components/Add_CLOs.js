...
import CancelIcon from "@mui/icons-material/Cancel";
  ...
  export default function Add_CLOs() {
                ...
                <div className="col-md-8">
                  ...
                  >
                    ...
                    >
                      ...
                      <MenuItem value={10}>ITP</MenuItem>
                      <MenuItem value={21}>ITC</MenuItem>
                      <MenuItem value={22}>OOP</MenuItem>
                    </Select>
                  </FormControl>
                </div>
              </div>
                ...
                <div className="col-md-8">
                  ...
                  >
                    ...
                    >
                      ...
                      <MenuItem value={10}>Congnitive</MenuItem>
                      <MenuItem value={21}>Psychomotor</MenuItem>
                      <MenuItem value={22}>Affective</MenuItem>
                    </Select>
                  </FormControl>
                </div>
                ...
                <div className="col-md-8">
                  ...
                  >
                    ...
                    >
                      ...
                      <MenuItem value={10}>Analyze a complex computing problem </MenuItem>
                      <MenuItem value={21}>Design, implement and evaluate a computing-based solution</MenuItem>
                      <MenuItem value={21}>Communicate effectively </MenuItem>
                      <MenuItem value={21}>Recognize professional responsibilities  </MenuItem>
                      <MenuItem value={21}>Leadership and team player </MenuItem>
                      <MenuItem value={21}>Apply software engineering theory </MenuItem>
