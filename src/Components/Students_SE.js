...
export default function Students_SE() {
  ...
  const rows = [
    { id: 1, regno: "3761",   name: "Shah Noor", dept: "Software Engineering" },
    { id: 2, regno: "3761",     name: "Shah Noor", dept: "Software Engineering" },
    { id: 3, regno: "3761",     name: "Shah Noor", dept: "Software Engineering" },
    { id: 4, regno: "3761",     name: "Shah Noor", dept: "Software Engineering" },
    { id: 5, regno: "3761",     name: "Shah Noor", dept: "Software Engineering" },
  ];
  return (
    <div className="m-5">
